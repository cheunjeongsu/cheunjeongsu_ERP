    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">CJS_Board<sup>0.1</sup></div>
            </a>
            ...
            <!-- 로그인 메뉴 -->
           	<li class="nav-item">
               <a class="nav-link" id="btnLogin" href="${path}/home/login">
                   <i class="fas fa-fw fa-cog"></i>
                   <span>로그인</span></a>
           	</li>
           	
           	<li class="nav-item">
               <a class="nav-link" id="btnLogout" href="${path}/home/logout">
                   <i class="fas fa-fw fa-cog"></i>
                   <span>로그아웃</span></a>
           	</li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
						(게시글 좋아요 많이 받은 순 1~3등, 최신 등록 게시글 등등)
                </div>
                <!-- /.container-fluid -->
