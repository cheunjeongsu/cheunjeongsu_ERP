    ...
    <div class="container-fluid" data-aos="fade" data-aos-delay="500">
      <div class="row">
        ...
        <!--   <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_1.jpg" alt="Image" class="img-fluid">
          </div> -->
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            <div class="image-info">
              <h2 class="mb-3">Daily</h2>
              <a href="${path}/board/" class="btn btn-outline-white py-2 px-4">More Photos</a>
            </div>
            <img src="/my/resources/images/img_2.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
       <!--  <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_3.jpg" alt="Image" class="img-fluid">
          </div>
        </div> -->
        ...
        <!-- <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_4.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_5.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_6.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="image-wrap-2">
            ...
            <img src="/my/resources/images/img_7.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
